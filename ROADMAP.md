...
- [x] Dev Mode: тёмная тема, границы блоков, подписи секций, сетка (Ctrl+Shift+D / #dev-on)
- [x] Header 2.0: компактное меню (5 пунктов), выпадающие подменю, кнопка «Связаться»
- [x] Карточки товаров: aspect-ratio 1:1, object-fit contain, изображения 400×400 px
- [x] Мобильное меню 3.0: выезжающая панель справа, подменю, копирование email
- [x] MAX добавлен во все списки контактов
- [x] Плавающие кнопки WhatsApp/Telegram убраны
- [x] Высота шапки увеличена
